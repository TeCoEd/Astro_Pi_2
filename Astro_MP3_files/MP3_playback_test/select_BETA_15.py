        ...
        if event.type == KEYDOWN:
            ...
            if event.key == K_DOWN and y < 7:
                ...
                if letter == "1":   ###'''add 3,4,5,6,7,8,9'''
                        print ("Mood 1")
                        sense.show_message("Mood 1", text_colour = [255, 255, 255])
                        MP3_Playlist()

                elif letter == "2":   ###'''add 3,4,5,6,7,8,9'''
                        print ("Mood 2")
                        sense.show_message("Mood 2", text_colour = [255, 255, 255])
                        MP3_Playlist() 


                elif letter == "3":   ###'''add 3,4,5,6,7,8,9'''
                        print ("Mood 3")
                        sense.show_message("Mood 3", text_colour = [255, 255, 255])
                        MP3_Playlist()
                        
                elif letter == "4":   ###'''add 3,4,5,6,7,8,9'''
                        print ("Mood 4")
                        sense.show_message("Mood 4", text_colour = [255, 255, 255])
                        MP3_Playlist()
                ...
                #################       
                        ...
                        print ("PLAYLIST 1")
                        sense.show_message("PlayList: Rock", text_colour = [255, 0, 0])
                        MP3_Playlist()        
                        ...
                        sense.show_message("PlayList: ISS Party", text_colour = [255, 255, 255])
                        print ("PLAYLIST 3")
                        MP3_Playlist()
                elif letter == "8":   ###'''add 3,4,5,6,7,8,9'''
                        print ("PLAYLIST 4")
                        sense.show_message("PlayList: Sonic Pi", text_colour = [255, 255, 255])
                        MP3_Playlist()
